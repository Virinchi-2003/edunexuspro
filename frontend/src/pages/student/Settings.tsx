          ...
          <Card className="border-none shadow-sm overflow-hidden rounded-3xl">
            ...
            <div className="px-6 pb-6 -mt-12">
              ...
              <p className="text-sm text-slate-500 flex items-center gap-1 mt-1 font-medium">
                <GraduationCap className="w-3.5 h-3.5" /> ID: {school?.school_id || 'SCH-XXX'}
              </p>
              ...
              <div className="mt-6 space-y-4 border-t border-slate-100 pt-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-slate-600 font-medium leading-relaxed">{school?.address || 'Loading...'}</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      <Badge className="bg-emerald-50 text-emerald-600 border-none capitalize">Verified Student</Badge>
              ...
              <Button variant="outline" className="w-full mt-8 rounded-xl gap-2 text-red-500 hover:text-red-600 hover:bg-red-50 border-red-100 font-bold" onClick={logout}>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="border-none shadow-sm rounded-3xl">
            <CardHeader>
              <CardTitle className="text-xl flex items-center gap-2 font-display">
                <User className="w-5 h-5 text-primary" /> Student Profile
              </CardTitle>
              <CardDescription>Update your personal information visible to your teachers and principal.</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleUpdateProfile} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className="bg-slate-50 border-none h-11 rounded-xl font-medium"
                ...
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    className="bg-slate-100 border-none h-11 rounded-xl opacity-70 font-medium cursor-not-allowed"
                  />
                ...
                <div className="flex justify-end pt-2">
                  <Button disabled={loading} className="rounded-xl px-8 shadow-lg shadow-primary/20 gap-2 font-bold h-12">
          ...
          <Card className="border-none shadow-sm rounded-3xl">
            <CardHeader>
              ...
              <CardDescription>Change your password periodically to keep your portal secure.</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleChangePassword} className="space-y-4">
                <div className="space-y-2">
                  <label className="text-sm font-bold text-slate-700 uppercase tracking-wider">Current Password</label>
                  <Input 
                    type="password"
                ...
                <div className="flex justify-end pt-2">
                  <Button type="submit" variant="outline" disabled={loading} className="rounded-xl px-8 gap-2 font-bold h-12">
